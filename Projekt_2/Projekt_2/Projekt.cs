        ...
        static void Main(string[] args)
        {
            ...
            while (akarsz == "i")
            {
                ...
                if (mit == "3")
                {
                    ...
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("Kő, papir, olló");
                    Console.ForegroundColor = ConsoleColor.White;

                    while (pont != 3 && geppont != 3)
                    {
                        Console.WriteLine();
                        Console.WriteLine("Játékos pontszám: " + pont + ". - Gép pontszám: " + geppont + ".");
                        string jatekos = "";
                        do
                        {
                            Console.Write("Válassz: Kő[k], papír[p], olló[o]?  ");
                            jatekos = Console.ReadLine();
                        } while (jatekos != "k" && jatekos != "p" && jatekos != "o");
                           

                        int gep = random.Next(0, 3);

                        if (gep == 0)
                        {
                            Console.WriteLine("Gép követ választott.");
                        ...
                        {
                            Console.WriteLine("Gép papírt választott.");
                        ...
                        {
                            Console.WriteLine("Gép ollót választott.");
                    ...
                    if (pont == 3)
                    {
                        ...
                        Console.WriteLine("Gratulálok, megnyerted a bajnokságot!");
                        Console.BackgroundColor = ConsoleColor.Black;
                    }
                    else
                    {
                        Console.BackgroundColor = ConsoleColor.Red;
                        Console.WriteLine("Sajnos, elveszetted a bajnokságot!");
                        Console.BackgroundColor = ConsoleColor.Black;
                ...
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("Szám kitalálás");
                    Console.ForegroundColor = ConsoleColor.White;
                    ...
                    int tippekszama = 1;
                    Console.WriteLine("1 és 100 között létrejön egy szám.");
                    Console.WriteLine("Ha kitalálod a számot, nyertél!");
                    ...
                    while (!jotipp)
                    {
                        ...
                        do
                        {
                            string tippp = Console.ReadLine();
                            if (szame(tippp) == true)
                            {
                                tipp = int.Parse(tippp);
                            }
                        } while (tipp < 0 || tipp > 100);
                        ...
                        {
                            Console.WriteLine("Gratulálok, kitaláltad " + tippekszama + " próbálkozásra.");
                            jotipp = true;
                        }
                    }
                }
                if (mit == "5")
                {
                    ...
                    int ellenfelelet = 0;
                    int tamadas = 0;
                    int ellenfeltamadas = 0;
                    int gyogyitas = 0;
                    int szint = 0;
                    do
                    {
                        Console.Write("Válassz nehézségi szintet(könnyű:1, közepes:2, nehéz:3, lehetetlen:4): ");
                        szint = Convert.ToInt32(Console.ReadLine());
                        Console.WriteLine();
                    } while (szint > 4 || szint < 1);

                    switch (szint)
                    {
                        case 1:
                            Console.WriteLine("Könnyű szint:");
                            elet = 60;
                            ellenfelelet = 20;
                            tamadas = 8;
                            ellenfeltamadas = 3;
                            gyogyitas = 5; break;
                        case 2:
                            Console.WriteLine("Közepes szint:");
                            elet = 31;
                            ellenfelelet = 35;
                            tamadas = 5;
                            ellenfeltamadas = 5;
                        ...
                        case 3:
                            ...
                            gyogyitas = 5; break;
                        case 4:
                            Console.WriteLine("Lehetetlen szint:");
                            elet = 20;
                            ellenfelelet = 45;
                            tamadas = 4;
                            ellenfeltamadas = 7;
                    ...
                    while (elet > 0 && ellenfelelet > 0)
                    {
                        Console.ForegroundColor = ConsoleColor.Blue;
                        Console.WriteLine("Játékos kör:");
                        Console.ForegroundColor = ConsoleColor.White;
                        Console.WriteLine("Élet: " + elet + " Ellenfél élet: " + ellenfelelet);
                        Console.WriteLine("Nyomjál 't' betűt a támadáshoz vagy 'g' betűt a gyógyításhoz.");

                        string choice = Console.ReadLine();

                        if (choice == "t")
                        {
                            ellenfelelet -= tamadas;
                            Console.WriteLine("A játékos ennyit sebzett: " + tamadas);
                        }
                        else
                        {
                            Console.WriteLine("A játékos ennyit sebzett: " + gyogyitas);
                            elet += gyogyitas;
                        }
                        Console.WriteLine();
                        ...
                        {
                            Console.ForegroundColor = ConsoleColor.Red;
                            Console.WriteLine("Ellenfél kör:");
                            Console.ForegroundColor = ConsoleColor.White;
                            Console.WriteLine("Játékos élete: " + elet + " Ellenfél élete: " + ellenfelelet);
                            int ellenfelvalasztas = r.Next(0, 2);

                            if (ellenfelvalasztas == 0)
                            {
                                elet -= ellenfeltamadas;
                                Console.WriteLine("Az ellenfél támadott és ennyit sebzett: " + ellenfeltamadas);
                            }
                            else
                            {
                                ellenfelelet += gyogyitas;
                                Console.WriteLine("Az ellenfél ennyit gyógyított: " + gyogyitas);
                            }
                            Console.WriteLine();
                        }
                    }
